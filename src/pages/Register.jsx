...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Після успішної реєстрації переходимо на головну
      navigate('/');
    } catch (err) {
  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <p style={s.subtitle}>Приєднуйся та відстежуй свої тренування</p>
        ...
        <form onSubmit={handleSubmit} style={s.form}>
          ...
          <div>
            <label style={s.label}>Підтвердження пароля</label>
            <input
              type="password"
